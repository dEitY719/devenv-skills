...
description: >-
  Manage dotfiles configuration files via symbolic links. Trigger on
  "/devenv:symlink-manager", "/devenv-symlink-manager", or when users
  request to manage config files with symbolic links, organize dotfiles, or
